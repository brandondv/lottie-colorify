const ur = (r) => {
  ...
  const e = Math.round(r[0] * 255).toString(16).padStart(2, "0"), a = Math.round(r[1] * 255).toString(16).padStart(2, "0"), o = Math.round(r[2] * 255).toString(16).padStart(2, "0");
  return `#${e}${a}${o}`;
}, Qa = (r) => [Math.round(r[0] * 255), Math.round(r[1] * 255), Math.round(r[2] * 255)], kt = (r) => [
  Math.round(r[0] * 255),
  Math.round(r[1] * 255),
  Math.round(r[2] * 255),
  r[3]
  ...
  const a = rn(r).map((c) => JSON.stringify(c)), o = new Set(a);
...
fr.exports;
(function(r, e) {
  var a = 200, o = "__lodash_hash_undefined__", c = 9007199254740991, l = "[object Arguments]", i = "[object Array]", p = "[object Boolean]", g = "[object Date]", f = "[object Error]", _ = "[object Function]", A = "[object GeneratorFunction]", w = "[object Map]", W = "[object Number]", q = "[object Object]", J = "[object Promise]", S = "[object RegExp]", T = "[object Set]", Yr = "[object String]", Xr = "[object Symbol]", br = "[object WeakMap]", Zr = "[object ArrayBuffer]", tr = "[object DataView]", Qr = "[object Float32Array]", rt = "[object Float64Array]", tt = "[object Int8Array]", et = "[object Int16Array]", at = "[object Int32Array]", nt = "[object Uint8Array]", ot = "[object Uint8ClampedArray]", st = "[object Uint16Array]", it = "[object Uint32Array]", Me = /[\\^$.*+?()[\]{}|]/g, Pe = /\w*$/, je = /^\[object .+?Constructor\]$/, Ee = /^(?:0|[1-9]\d*)$/, h = {};
  h[l] = h[i] = h[Zr] = h[tr] = h[p] = h[g] = h[Qr] = h[rt] = h[tt] = h[et] = h[at] = h[w] = h[W] = h[q] = h[S] = h[T] = h[Yr] = h[Xr] = h[nt] = h[ot] = h[st] = h[it] = !0, h[f] = h[_] = h[br] = !1;
  var ke = typeof j == "object" && j && j.Object === Object && j, Oe = typeof self == "object" && self && self.Object === Object && self, C = ke || Oe || Function("return this")(), ct = e && !e.nodeType && e, ut = ct && !0 && r && !r.nodeType && r, De = ut && ut.exports === ct;
  function Ge(t, n) {
  ...
  function Ue(t, n) {
    for (var s = -1, u = n.length, d = t.length; ++s < u; )
      t[d + s] = n[s];
    return t;
  }
  function ft(t, n, s, u) {
    for (var d = -1, $ = t ? t.length : 0; ++d < $; )
      s = n(s, t[d], d, t);
    return s;
  }
  function Le(t, n) {
    for (var s = -1, u = Array(t); ++s < t; )
      u[s] = n(s);
    return u;
  }
  function Ne(t, n) {
  ...
  var Ke = Array.prototype, He = Function.prototype, er = Object.prototype, Tr = C["__core-js_shared__"], ht = function() {
    var t = /[^.]+$/.exec(Tr && Tr.keys && Tr.keys.IE_PROTO || "");
    return t ? "Symbol(src)_1." + t : "";
  }(), yt = He.toString, P = er.hasOwnProperty, ar = er.toString, Re = RegExp(
    "^" + yt.call(P).replace(Me, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
  ), vt = De ? C.Buffer : void 0, _t = C.Symbol, dt = C.Uint8Array, Ve = Ar(Object.getPrototypeOf, Object), ze = Object.create, We = er.propertyIsEnumerable, qe = Ke.splice, $t = Object.getOwnPropertySymbols, Je = vt ? vt.isBuffer : void 0, Ye = Ar(Object.keys, Object), Sr = U(C, "DataView"), Y = U(C, "Map"), wr = U(C, "Promise"), mr = U(C, "Set"), Cr = U(C, "WeakMap"), X = U(Object, "create"), Xe = O(Sr), Ze = O(Y), Qe = O(wr), ra = O(mr), ta = O(Cr), bt = _t ? _t.prototype : void 0, At = bt ? bt.valueOf : void 0;
  function E(t) {
    var n = -1, s = t ? t.length : 0;
    for (this.clear(); ++n < s; ) {
      var u = t[n];
      this.set(u[0], u[1]);
    }
  ...
  function Ta(t, n) {
    var s = Mr(t) || za(t) ? Le(t.length, String) : [], u = s.length, d = !!u;
    for (var $ in t)
      P.call(t, $) && !(d && ($ == "length" || Ka($, u))) && s.push($);
    return s;
  }
  function Tt(t, n, s) {
    var u = t[n];
  ...
  function xa(t) {
    ...
    for (var s in Object(t))
      P.call(t, s) && s != "constructor" && n.push(s);
    return n;
  }
  function Ma(t, n) {
    if (n)
  ...
  var wt = $t ? Ar($t, Object) : Xa, k = Ca;
  (Sr && k(new Sr(new ArrayBuffer(1))) != tr || Y && k(new Y()) != w || wr && k(wr.resolve()) != J || mr && k(new mr()) != T || Cr && k(new Cr()) != br) && (k = function(t) {
    var n = ar.call(t), s = n == q ? t.constructor : void 0, u = s ? O(s) : void 0;
    if (u)
      switch (u) {
        case Xe:
          return tr;
  ...
  function Ua(t) {
    var n = t.length, s = t.constructor(n);
  ...
  function mt(t) {
    var n = t && t.constructor, s = typeof n == "function" && n.prototype || er;
    return t === s;
  }
  function O(t) {
    if (t != null) {
...
var hr = sn, cn = hr, un = Array.prototype, fn = un.splice;
function ln(r) {
  var e = this.__data__, a = cn(e, r);
  if (a < 0)
    return !1;
  var o = e.length - 1;
...
var Dn = On, Gn = typeof j == "object" && j && j.Object === Object && j, ie = Gn, Fn = ie, Bn = typeof self == "object" && self && self.Object === Object && self, Un = Fn || Bn || Function("return this")(), m = Un, Ln = m, Nn = Ln.Symbol, Ur = Nn, Ot = Ur, ce = Object.prototype, Kn = ce.hasOwnProperty, Hn = ce.toString, Z = Ot ? Ot.toStringTag : void 0;
function Rn(r) {
  var e = Kn.call(r, Z), a = r[Z];
  try {
    r[Z] = void 0;
    var o = !0;
  } catch {
...
var Jn = qn, Dt = Ur, Yn = Vn, Xn = Jn, Zn = "[object Null]", Qn = "[object Undefined]", Gt = Dt ? Dt.toStringTag : void 0;
function ro(r) {
...
var Q = to, eo = vr, ao = Q, no = "[object AsyncFunction]", oo = "[object Function]", so = "[object GeneratorFunction]", io = "[object Proxy]";
function co(r) {
  if (!ao(r))
    return !1;
  var e = eo(r);
...
var ue = co, uo = m, fo = uo["__core-js_shared__"], lo = fo, Er = lo, Ft = function() {
...
var G = Do, Go = G, Fo = m, Bo = Go(Fo, "Map"), Lr = Bo, Uo = G, Lo = Uo(Object, "create"), _r = Lo, Bt = _r;
function No() {
...
var Ro = Ho, Vo = _r, zo = "__lodash_hash_undefined__", Wo = Object.prototype, qo = Wo.hasOwnProperty;
function Jo(r) {
  var e = this.__data__;
  if (Vo) {
    var a = e[r];
...
var Yo = Jo, Xo = _r, Zo = Object.prototype, Qo = Zo.hasOwnProperty;
function rs(r) {
  var e = this.__data__;
  return Xo ? e[r] !== void 0 : Qo.call(e, r);
}
var ts = rs, es = _r, as = "__lodash_hash_undefined__";
function ns(r, e) {
  var a = this.__data__;
  return this.size += this.has(r) ? 0 : 1, a[r] = es && e === void 0 ? as : e, this;
}
var os = ns, ss = Ko, is = Ro, cs = Yo, us = ts, fs = os;
function H(r) {
  var e = -1, a = r == null ? 0 : r.length;
  for (this.clear(); ++e < a; ) {
    var o = r[e];
...
R.prototype.has = Ds;
R.prototype.set = Gs;
var Fs = R, Bs = yr, Us = Lr, Ls = Fs, Ns = 200;
function Ks(r, e) {
  var a = this.__data__;
  if (a instanceof Bs) {
    var o = a.__data__;
    if (!Us || o.length < Ns - 1)
      return o.push([r, e]), this.size = ++a.size, this;
    a = this.__data__ = new Ls(o);
  }
  return a.set(r, e), this.size = a.size, this;
}
var Hs = Ks, Rs = yr, Vs = Mn, zs = jn, Ws = kn, qs = Dn, Js = Hs;
function V(r) {
...
function fi(r, e, a, o) {
  ...
  for (var l = -1, i = e.length; ++l < i; ) {
    var p = e[l], g = o ? o(a[p], r[p], p, a, r) : void 0;
...
var rr = gi, hi = vr, yi = rr, vi = "[object Arguments]";
function _i(r) {
  return yi(r) && hi(r) == vi;
}
var di = _i, Nt = di, $i = rr, ge = Object.prototype, bi = ge.hasOwnProperty, Ai = ge.propertyIsEnumerable, Ti = Nt(/* @__PURE__ */ function() {
  return arguments;
}()) ? Nt : function(r) {
  return $i(r) && bi.call(r, "callee") && !Ai.call(r, "callee");
}, Si = Ti, wi = Array.isArray, Nr = wi, lr = { exports: {} };
function mi() {
  return !1;
}
var Ci = mi;
lr.exports;
(function(r, e) {
  var a = m, o = Ci, c = e && !e.nodeType && e, l = c && !0 && r && !r.nodeType && r, i = l && l.exports === c, p = i ? a.Buffer : void 0, g = p ? p.isBuffer : void 0, f = g || o;
  r.exports = f;
})(lr, lr.exports);
var he = lr.exports, Ii = 9007199254740991, xi = /^(?:0|[1-9]\d*)$/;
function Mi(r, e) {
  var a = typeof r;
...
var Kr = cc, pr = { exports: {} };
pr.exports;
(function(r, e) {
  var a = ie, o = e && !e.nodeType && e, c = o && !0 && r && !r.nodeType && r, l = c && c.exports === o, i = l && a.process, p = function() {
    try {
...
var Hr = pr.exports, uc = ic, fc = Kr, Kt = Hr, Ht = Kt && Kt.isTypedArray, lc = Ht ? fc(Ht) : uc, pc = lc, gc = pi, hc = Si, yc = Nr, vc = he, _c = Pi, dc = pc, $c = Object.prototype, bc = $c.hasOwnProperty;
function Ac(r, e) {
  var a = yc(r), o = !a && hc(r), c = !a && !o && vc(r), l = !a && !o && !c && dc(r), i = a || o || c || l, p = i ? gc(r.length, String) : [], g = p.length;
  for (var f in r)
    (e || bc.call(r, f)) && !(i && // Safari 9 has enumerable `arguments.length` in strict mode.
...
function Sc(r) {
  var e = r && r.constructor, a = typeof e == "function" && e.prototype || Tc;
  return r === a;
}
var Rr = Sc;
function wc(r, e) {
...
var _e = wc, mc = _e, Cc = mc(Object.keys, Object), Ic = Cc, xc = Rr, Mc = Ic, Pc = Object.prototype, jc = Pc.hasOwnProperty;
function Ec(r) {
  if (!xc(r))
    return Mc(r);
  var e = [];
  for (var a in Object(r))
    jc.call(r, a) && a != "constructor" && e.push(a);
  return e;
}
...
var zc = Vc, Wc = Q, qc = Rr, Jc = zc, Yc = Object.prototype, Xc = Yc.hasOwnProperty;
function Zc(r) {
  if (!Wc(r))
    return Jc(r);
  var e = qc(r), a = [];
  for (var o in r)
    o == "constructor" && (e || !Xc.call(r, o)) || a.push(o);
  return a;
}
var Qc = Zc, ru = ve, tu = Qc, eu = de;
function au(r) {
  return eu(r) ? ru(r, !0) : tu(r);
}
var zr = au, nu = $r, ou = zr;
function su(r, e) {
  return r && nu(e, ou(e), r);
}
var iu = su, gr = { exports: {} };
gr.exports;
(function(r, e) {
  var a = m, o = e && !e.nodeType && e, c = o && !0 && r && !r.nodeType && r, l = c && c.exports === o, i = l ? a.Buffer : void 0, p = i ? i.allocUnsafe : void 0;
  function g(f, _) {
    if (_)
      return f.slice();
...
var $e = gu, hu = pu, yu = $e, vu = Object.prototype, _u = vu.propertyIsEnumerable, Rt = Object.getOwnPropertySymbols, du = Rt ? function(r) {
  return r == null ? [] : (r = Object(r), hu(Rt(r), function(e) {
    return _u.call(r, e);
  }));
} : yu, Wr = du, $u = $r, bu = Wr;
function Au(r, e) {
...
var Tu = Au;
function Su(r, e) {
  for (var a = -1, o = e.length, c = r.length; ++a < o; )
    r[c + a] = e[a];
  return r;
}
var be = Su, wu = _e, mu = wu(Object.getPrototypeOf, Object), Ae = mu, Cu = be, Iu = Ae, xu = Wr, Mu = $e, Pu = Object.getOwnPropertySymbols, ju = Pu ? function(r) {
  for (var e = []; r; )
    Cu(e, xu(r)), r = Iu(r);
  return e;
} : Mu, Te = ju, Eu = $r, ku = Te;
...
var Du = Ou, Gu = be, Fu = Nr;
function Bu(r, e, a) {
  var o = e(r);
  return Fu(r) ? o : Gu(o, a(r));
}
var Se = Bu, Uu = Se, Lu = Wr, Nu = Vr;
function Ku(r) {
  return Uu(r, Nu, Lu);
}
var Hu = Ku, Ru = Se, Vu = Te, zu = zr;
function Wu(r) {
  return Ru(r, zu, Vu);
}
var qu = Wu, Ju = G, Yu = m, Xu = Ju(Yu, "DataView"), Zu = Xu, Qu = G, rf = m, tf = Qu(rf, "Promise"), ef = tf, af = G, nf = m, of = af(nf, "Set"), sf = of, cf = G, uf = m, ff = cf(uf, "WeakMap"), lf = ff, kr = Zu, Or = Lr, Dr = ef, Gr = sf, Fr = lf, we = vr, z = fe, Vt = "[object Map]", pf = "[object Object]", zt = "[object Promise]", Wt = "[object Set]", qt = "[object WeakMap]", Jt = "[object DataView]", gf = z(kr), hf = z(Or), yf = z(Dr), vf = z(Gr), _f = z(Fr), D = we;
(kr && D(new kr(new ArrayBuffer(1))) != Jt || Or && D(new Or()) != Vt || Dr && D(Dr.resolve()) != zt || Gr && D(new Gr()) != Wt || Fr && D(new Fr()) != qt) && (D = function(r) {
  var e = we(r), a = e == pf ? r.constructor : void 0, o = a ? z(a) : "";
  if (o)
    switch (o) {
      case gf:
        return Jt;
...
var jf = Pf, Xt = Ur, Zt = Xt ? Xt.prototype : void 0, Qt = Zt ? Zt.valueOf : void 0;
function Ef(r) {
...
var Gf = Df, Ff = Jr, Bf = xf, Uf = jf, Lf = kf, Nf = Gf, Kf = "[object Boolean]", Hf = "[object Date]", Rf = "[object Map]", Vf = "[object Number]", zf = "[object RegExp]", Wf = "[object Set]", qf = "[object String]", Jf = "[object Symbol]", Yf = "[object ArrayBuffer]", Xf = "[object DataView]", Zf = "[object Float32Array]", Qf = "[object Float64Array]", rl = "[object Int8Array]", tl = "[object Int16Array]", el = "[object Int32Array]", al = "[object Uint8Array]", nl = "[object Uint8ClampedArray]", ol = "[object Uint16Array]", sl = "[object Uint32Array]";
function il(r, e, a) {
  var o = r.constructor;
  switch (e) {
    case Yf:
...
var cl = il, ul = Q, re = Object.create, fl = /* @__PURE__ */ function() {
  function r() {
  }
  return function(e) {
    if (!ul(e))
...
}(), ll = fl, pl = ll, gl = Ae, hl = Rr;
function yl(r) {
  return typeof r.constructor == "function" && !hl(r) ? pl(gl(r)) : {};
}
var vl = yl, _l = qr, dl = rr, $l = "[object Map]";
function bl(r) {
  return dl(r) && _l(r) == $l;
}
var Al = bl, Tl = Al, Sl = Kr, te = Hr, ee = te && te.isMap, wl = ee ? Sl(ee) : Tl, ml = wl, Cl = qr, Il = rr, xl = "[object Set]";
function Ml(r) {
  return Il(r) && Cl(r) == xl;
}
var Pl = Ml, jl = Pl, El = Kr, ae = Hr, ne = ae && ae.isSet, kl = ne ? El(ne) : jl, Ol = kl, Dl = Ys, Gl = Zs, Fl = pe, Bl = Rc, Ul = iu, Ll = cu, Nl = fu, Kl = Tu, Hl = Du, Rl = Hu, Vl = qu, zl = qr, Wl = Af, ql = cl, Jl = vl, Yl = Nr, Xl = he, Zl = ml, Ql = Q, rp = Ol, tp = Vr, ep = zr, ap = 1, np = 2, op = 4, me = "[object Arguments]", sp = "[object Array]", ip = "[object Boolean]", cp = "[object Date]", up = "[object Error]", Ce = "[object Function]", fp = "[object GeneratorFunction]", lp = "[object Map]", pp = "[object Number]", Ie = "[object Object]", gp = "[object RegExp]", hp = "[object Set]", yp = "[object String]", vp = "[object Symbol]", _p = "[object WeakMap]", dp = "[object ArrayBuffer]", $p = "[object DataView]", bp = "[object Float32Array]", Ap = "[object Float64Array]", Tp = "[object Int8Array]", Sp = "[object Int16Array]", wp = "[object Int32Array]", mp = "[object Uint8Array]", Cp = "[object Uint8ClampedArray]", Ip = "[object Uint16Array]", xp = "[object Uint32Array]", y = {};
...
function cr(r, e, a, o, c, l) {
  ...
  if (a && (i = c ? a(r, o, c, l) : a(r)), i !== void 0)
    return i;
  if (!Ql(r))
    return r;
  var _ = Yl(r);
  if (_) {
    ...
    var A = zl(r), w = A == Ce || A == fp;
    if (Xl(r))
      return Ll(r, p);
    if (A == Ie || A == me || w && !c) {
      if (i = g || w ? {} : Jl(r), !p)
        return g ? Hl(r, Ul(i, r)) : Kl(r, Bl(i, r));
    } else {
      if (!y[A])
        return c ? r : {};
      i = ql(r, A, p);
  ...
  if (W)
    return W;
  l.set(r, i), rp(r) ? r.forEach(function(S) {
    i.add(cr(S, e, a, S, r, l));
  }) : Zl(r) && r.forEach(function(S, T) {
    i.set(T, cr(S, e, a, T, r, l));
  });
  var q = f ? g ? Vl : Rl : g ? ep : tp, J = _ ? void 0 : q(r);
  return Gl(J || r, function(S, T) {
    J && (T = S, S = r[T]), Fl(i, T, cr(S, e, a, T, r, l));
  }), i;
}
var Mp = cr, Pp = Mp, jp = 1, Ep = 4;
function kp(r) {
  return Pp(r, jp | Ep);
}
var Op = kp;
const Dp = /* @__PURE__ */ oe(Op), Gp = (r, e, a = !0) => {
  let o = 0;
  function c(l, i) {
  ...
  return c(o, a ? Br(e) : e);
}, M = (r) => Math.round(r * 1e3) / 1e3, N = 3e-3, xe = (r, e, a, o = !0) => {
  const c = ur(r), l = ur(e);
  if (!c || !l)
...
}, Np = (r, e) => r.reduce((a, [o, c]) => xe(o, c, a), e), Kp = (r, e, a) => {
  let o = { ...a };
